...
#[map]
pub static PROF_PATH_WALK_HIST: HashMap<u32, u64> = HashMap::with_max_entries(64, 0);

// Path assembly time histogram (log2 bucket key, count value)
#[map]
pub static PROF_PATH_ASSEMBLY_HIST: HashMap<u32, u64> = HashMap::with_max_entries(64, 0);
